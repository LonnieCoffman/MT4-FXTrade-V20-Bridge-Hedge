# path to the directory where MT4 will write trade files to.
filepath = "C:\\Path\\to\\mql4\\Files\\FXtrade\\"

# one V20 account number for short trades and one for long trades
